...
<span class="desc-info">
    ...
    <span class="box">
        ...
        Sie selbst, als Backenduser, greifen nur indirekt auf diese zu, obwohl sie, soweit
...
Info-Popup den Zeitpunkt der letzten Aktualisierung an. Für beide hier gezeigten
(timestamp) Zeitangaben gilt, dass sie in GMT Zeit angezeigt werden, d.h. nicht
unbedingt ihrer lokalen Zeitzone bzw. dem eingestellten Offset entsprechen.</p>
...
<p>Innerhalb der Zeile, die den Artikel anzeigt, werden auf der rechten Seite
...
de-selektieren und jeden nicht-selektierten Artikel wieder auswählen. Wenn
...
eines hochzuladenden Bildes</strong> bereits Rechnung, mittels derer man ein festes Maß als Maximalmaß
...
<p>Dieses Kernstück wurde für AVIF erst ab <strong>PHP 8.2</strong> Ende des Jahres 2022
zur Verfügung gestellt. Bis dahin konnte AVIF mit PHP 8.1 nur eingeschränkt benutzt werden.
Diese Einschränkung beinhaltete alles, was über die Konvertierung eines hochgeladenen
Bildes (in das Serendipity <em>Thumbnails</em> Vorschaubild) hinausging, also zB. spätere
Skalierungen des vorliegenden Bildformates "Dateiausmaße ändern", sowie Änderungen
...
Option dann immer alle Dateiformate betrifft, denn für eine Rotation muss das Ausgangsbild,
sein Thumbnail, und eben wie diese, auch die WebP/AVIF Variationen gedreht werden, wurden
Vorkehrungen getroffen solcherlei Änderungen mit dieser PHH Version zu unterbinden.</p>

<p>Unter anderem aus diesem Grunde steht AVIF bislang nur als Option in <strong>Konfiguration
...
<figure>
    <a class="lightbox" rel="lightbox" href="media/lib_variation_comparison.avif" lg-uid="lg450" data-fallback="media/lib_variation_comparison.webp">
      <picture>
        <source srcset="media/lib_variation_comparison.avif" type="image/avif">
        <source srcset="media/lib_variation_comparison.webp" type="image/webp">
        <img src="media/lib_variation_comparison.png" alt="lib_variation_comparison.png" loading="lazy" width="1120" height="760">
      </picture>
    </a>
...
Vorschaubild-Suffix durchzuführen, falls Sie sich mittendrin entscheiden sollten, die Serendipity
...
<span class="tag-box invisible">
    <span class="inline-tag">Konfiguration!Vorschaubild-Suffix</span>
    <span class="inline-tag">Thumbnails</span>
    <span class="inline-tag">serendipity-Thumb@styxThumb</span>
    <span class="inline-tag">serendipity-Thumb@serendipityThumb</span>
</span><!-- tagbox -->
<span class="item mbold">Vorschaubild-Suffix</span><!-- menuitem -->
<span class="desc-info">
    <span class="box">
    ...
    <span class="box">
        Diesen Dateinamen können Sie über die Option <span class="mbold">Vorschaubild-Suffix</span>
...
<span class="desc-info">
    <span class="box">
        Legt fest, <b>wie</b> die Größe des Bildes beim Upload angepasst werden soll.
...
<span class="tag-box invisible">
    <span class="inline-tag">Konfiguration!maximale Breite/Höhe eines hochzuladenden Bildes</span>
</span><!-- tagbox -->
<span class="item mbold">Maximale Breite eines hochzuladenden Bildes</span><!-- menuitem -->
<span class="item mbold">Maximale Höhe eines hochzuladenden Bildes</span><!-- menuitem -->
<span class="desc-info">Abgesehen von der Dateigröße können Sie ein hochzuladendes Bild auch auf
...
<p class="desc-info">
    ...
    <span class="box">
        <span class="mbold">UTF8mb4</span> ist <u>für MySQL</u> eine Obermenge von UTF-8.
    </span>
