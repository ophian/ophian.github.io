...
Sie fasst die Ausgaben verschiedener bereits erwähnten <code>media_*.tpl</code> Dateien für die Ausgabe zusammen.</span>
</p>
...
<p class="desc citem-desc">
<span class="tag-box invisible">
    <span class="inline-tag">Template-Dateien!styx_logo_150.png</span>
    <span class="inline-tag">Template-Dateien!s9y_banner_small.png (deprecated)</span>
</span>
<code class="item file">../styx_logo_150.png</code>
<code class="item file">img/s9y_banner_small.png (deprecated)</code>
<span class="desc-info">
    <span class="box">
        Zeigt ein kleines Werbebanner für Serendipity Styx, das vom Plugin <em>Powered
        by</em> (siehe Seite <span class="pageref"><a href="#plugplugin">plugplugin</a></span>)
        in der Seitenleiste dargestellt werden kann. Ab Serendipity Styx 4.2 wird dies
        offiziell durch das neue Styx Logo in templates/ ersetzt und das alte S9y Logo als
        deprecated zurückgestuft. Styx 5.0 wird es dann komplett in allen Vorkommen entfernen.
    </span>

    <span class="box">
        Dasselbe Logo ist aus Vereinfachungsgründen auch generell unter
        <code class="item file">/templates/styx_logo_150.png</code> bzw
        <code class="item file">/templates/s9y_banner_small.png</code> (deprecated) erreichbar,
...
<p><span class="mbold">Grundsätzlich</span> gilt aber festzuhalten: <span class="mbold"><em>Weniger ist mehr!</em></span>
Abgesehen vom Spaß den dieses dennoch machen könnte, reichen einfache Kenntnisse von HTML und CSS meist aus, um ein
...
<span class="desc-info">
    ...
    <span class="box mda-box">
        ...
        <span class="box"><code class="sub-item smarty">{$admin_vars.no_footer}</code>
            <span class="sub-box">
                <span class="smarty-type"><em>Variablentyp:</em> <code class="type">Boolean</code></span>
            </span>
            <span class="sub-box">
                Gibt an, ob die Fußleiste im Backend-Bereich eingebunden werden soll.
        ...
        <span class="box"><code class="sub-item smarty">{$admin_vars.popup_content}</code>
            ...
            <span class="sub-box">
                ...
                eingebunden werden sollen. Dies verkürzt den GET URI string. Benutzbar mit Styx 5.1+.
                Mittels der URL-Variable
...
<p>Die Template-Datei <code>entries.tpl</code> ist die zentrale Datei für die
