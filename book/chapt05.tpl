...
in <code>include/plugin_internal.inc.php</code> zusammengefasst.</p>
...
<section id="serendipity_plugin_socialbookmarks" class="sub">
<span class="u-toc">5.3.8 - Social Bookmarks-Plugin: serendipity_plugin_socialbookmarks</span>

<h3 class="subsection" id="social-bookmarks-pluginserendipity_plugin_socialbookmarks">Social Bookmarks-Plugin<br>serendipity_plugin_socialbookmarks</h3>

<p class="tagging invisible">
<span class="tag-box invisible">
    <span class="inline-tag">del.icio.us</span>
    <span class="inline-tag">magnolia@ma.gnolia</span>
    <span class="inline-tag">Webservices</span>
    <span class="inline-tag">furl.net</span>
    <span class="inline-tag">linkroll</span>
    <span class="inline-tag">Mister Wong</span>
    <span class="inline-tag">Plugins!Social Bookmarks plugin</span>
    <span class="inline-tag">Lesezeichen</span>
    <span class="inline-tag">Favoriten</span>
    <span class="inline-tag">Plugins!serendipity_plugin_socialbookmarks</span>
</span>
</p>

<p>Das <em>Social Bookmarks</em>-Plugin ermöglicht es Ihnen, Ihre bei externen
...
beliebigen Rechner im Internet aufrufen können.</p>

<p>Wenn Sie die Lesezeichen in Ihrem Blog einbinden, können Sie Ihre
Besucher darüber informieren, welche Seiten Sie gerade interessant
finden.</p>

<p>Die meisten Webservices bieten eigenständige JavaScripts an, die Sie auf
...
Serendipity-Plugin einiges an Arbeit ab.</p>

<p>Das Plugin können Sie beliebig oft installieren, und es muss jeweils immer
...
nicht von einer Firewall bei ausgehenden Verbindungen blockiert werden.</p>

<p>Folgende Konfigurationsoptionen stehen zur Auswahl:</p>

<p class="desc">
<span class="item mbold">Service</span><!-- menuitem -->
<span class="desc-info">In dem Auswahlfeld <em>Service</em> müssen Sie auswählen, welchen
Webservice Sie ansprechen wollen. Vom gewählten Service sind einige der
weiteren Konfigurationsoptionen abhängig.</span>
</p>

<p class="desc">
<span class="item mbold">Benutzername</span><!-- menuitem -->
<span class="desc-info">
    <span class="box">
        ...
        Feld <span class="mbold">Benutzername</span> eintragen, um die Links des gewählten Benutzers
        anzuzeigen.
    </span>
...
<p class="desc">
<span class="item mbold">Anzahl der darzustellenden Links</span><!-- menuitem -->
<span class="desc-info">Das Plugin kann höchstens die Anzahl der Lesezeichen einbinden, die im
RSS-Feed des jeweiligen Benutzers vorhanden sind. Abhängig vom Service
sind dies meist die letzten 30 Links. Im Feld <span class="mbold">Anzahl der
darzustellenden Links</span> können Sie die Anzahl der ausgegebenen Links daher
weiter einschränken. Ein höherer Wert ist prinzipiell nutzlos und kann nicht
mehr Links als die verfügbare Anzahl anzeigen.</span>
</p>

<p class="desc">
<span class="item mbold">Wann soll der Feed aktualisiert werden</span><!-- menuitem -->
<span class="desc-info">Damit das Plugin nicht bei jedem Seitenaufruf des Besuchers neu
ausgeführt werden muss, können die Ausgaben zwischengespeichert werden.
Im Feld <em>Wann soll der Feed aktualisiert werden</em> tragen Sie die
Anzahl der Stunden ein, für die ein Feed zwischengespeichert werden kann.
Erst nach Ablauf dieser Zeit wird der Webservice erneut angefragt.</span>
</p>

<p class="desc">
<span class="item mbold">Zeig "mehr"-Verknüpfung</span><!-- menuitem -->
<span class="desc-info">Da der RSS-Feed meistens nicht alle verfügbaren Links beinhaltet, können
...
dieser "mehr"-Link eingebettet.</span>
</p>
...
<span class="item mbold">Tags anzeigen</span><!-- menuitem -->
<span class="desc-info">
    <span class="box">
        ...
        identifizieren. Mit Hilfe dieser <em>Tags</em> ist es leicht
        möglich, andere Lesezeichen weiterer Benutzer anzuzeigen, die ähnliche
        Stichwörter benutzt haben.
    </span>

    <span class="box">
        Wenn Sie die Option <span class="mbold">Tags anzeigen</span> aktivieren, werden Ihnen die
...
<p class="desc">
<span class="item mbold">Feed-Einstellungen</span><!-- menuitem -->
<span class="desc-info">
    <span class="box">
        ...
        benutzen. <span class="mbold">Neueste Lesezeichen aller Benutzer</span> zeigt die aktuellsten
    ...
    <span class="box">
        Speziell für den del.icio.us-Webservice gibt es die Option <span class="mbold">Meine
...
<p class="desc">
<span class="item mbold">Vorschaugrafiken anzeigen (ma.gnolia)</span><!-- menuitem -->
<span class="desc-info">Der Webservice ma.gnolia bietet eine kleine Vorschaugrafik der Webseite
an, die Sie als Lesezeichen gespeichert haben. Wenn Sie die Option
<span class="mbold">Vorschaugrafiken anzeigen</span> aktivieren, wird diese Grafik anstelle
des Lesezeichen-Texts angezeigt, um dem Besucher bereits einen optischen
Vorgeschmack auf die Seite geben zu können.</span>
</p>

<p class="desc">
<span class="item mbold">Zusätzliche Parameter für die Einstellung "Meine Tagcloud"</span><!-- menuitem -->
<span class="desc-info">Wenn Sie für die <span class="mbold">Feed-Einstellungen</span> die Option <span class="mbold">Meine
Tagcloud</span> gewählt haben, können Sie einige Parameter für die Formatierung
der Schlagwortliste vornehmen. Eine Auflistung aller verfügbaren
Parameter finden Sie unter <code>http://del.icio.us/help/tagrolls</code>.</span>
</p>
