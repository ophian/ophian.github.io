...
<p class="desc">
<span class="item mbold">Schriftgröße der Tags nach Häufigkeit skalieren</span><!-- menuitem -->
...
<p class="desc">
<span class="item mbold">Mindest-Nutzung eines Tags für Anzeige</span><!-- menuitem -->
...
Es kann vorkommen, wenn Sie das Plugin <span class="mbold">Statische Seiten</span> aufgrund eines Fehlers mehr als
einmal installiert hatten, dass Sie einige Seitentypen mehrfach in der
