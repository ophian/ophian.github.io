...
<span class="desc-info">
    ...
    <span class="box">
        Die Dateien <code>db_update_X_Y_Z.sql</code> enthalten die SQL-Anweisungen, die
        beim Aktualisieren von Serendipity automatisch ausgeführt werden sollen, um neue
        Tabellen zu erstellen bzw. bestehende Tabellen anzupassen. Dabei steht <code>X</code>
        für die vorher installierte Serendipity-Version und <code>Y</code> für die neue
        Version. Bei einem Update werden alle Versionszwischenstände
        ebenfalls ausgeführt. <code>Z</code> steht dabei für das verwendete
        Datenbank-Zielsystem (MySQL, PostgreSQL oder SQLite).
    </span>
</span>
</p>
...
<span class="desc-info">
    <span class="box">
        Enthält die verfügbaren Templates. Das Verzeichnis <code>2k11</code> enthält
        ...
        Datei verfügt. Das Verzeichnis <code>default</code> enthält darüber hinaus weitere
        Standarddateien, falls diese nicht im Verzeichnis <code>2k11</code> liegen.
...
<code class="item function">serendipity_resize_image_gd()</code>, 
(<code class="item file">include/functions_images.inc.php</code>)
<span class="desc-info">
    <span class="box">
...
<code class="item function">serendipity_rotate_image_gd()</code>, 
(<code class="item file">include/functions_images.inc.php</code>)
<span class="desc-info">
    <span class="box">
        Rotiert ein Bild.
...
<p class="desc">
<code class="item function">serendipity_functions_gd()</code>, 
(<code class="item file">include/functions_images.inc.php</code>)
<span class="desc-info">
    <span class="box">
...
<p class="desc">
<code class="item function">serendipity_getimagesize()</code>, 
(<code class="item file">include/functions_images.inc.php</code>)
<span class="desc-info">
    <span class="box">
...
<span class="desc-info">
    ...
    <span class="box">
        <span id="pre-style"><code class="txt">
            serendipity_event_nl2br:event<br>
...
<span class="desc-info">
    <span class="box group-box">
        wird ausgeführt, wenn das
        <code>serendpity_event_linklist</code>-Plugin installiert und ausgeführt wird.
        <span class="subdesc">
...
<span class="desc-info">
    <span class="box group-box">
        wird ausgeführt, wenn das
        <code>serendpity_event_linklist</code>-Plugin installiert und konfiguriert wird.
        <span class="subdesc">
...
<span class="desc-info">
    <span class="box group-box">
        wird ausgeführt, wenn das
        <code>serendpity_event_freetag</code>-Plugin installiert und ausgeführt wird
...
<span class="desc-info">
    <span class="box group-box">
        wird ausgeführt, wenn das
        <code>serendpity_event_gravatar</code>-Plugin installiert und ausgeführt wird.
...
<span class="desc-info">
    <span class="box group-box">
        wird ausgeführt, wenn das
        <code>serendpity_event_creativecommons</code>-Plugin installiert
...
einer Domain laufen und über <code>http://blogs.seniorgamer.de/shooter/</code> und
<code>http://blogs.seniorgamer.de/mmorpg/</code> aufgerufen werden. Das dritte Blog
...
<p class="desc">
    <code class="item">/home/www/seniorgamer.de/htdocs/</code> für Blog 1 und 2
...
Verzeichnis <code>/home/www/seniorgamer.de/htdocs/</code> als Ziel unseres
...
<code>/home/www/seniorgamer.de/htdocs/Serendipity</code>. Sobald Sie die Dateien
...
<pre><code class="txt">
    ...
    /home/www/seniorgamer.de/htdocs/mmorpg/<br>
    /home/www/percanat-blog/htdocs/
</code></pre>

<p>In jedes dieser drei leeren Verzeichnisse kopieren wir nun den vollständigen
Inhalt des Core-Verzeichnisses
<code>/home/www/seniorgamer.de/htdocs/Serendipity/deployment</code>. Danach sollten Sie
in jedem der drei Verzeichnisse eine Liste wie folgende besitzen:</p>

<pre><code class="txt">
    /home/www/seniorgamer.de/htdocs/shooter/comment.php<br>
    /home/www/seniorgamer.de/htdocs/shooter/exit.php<br>
    /home/www/seniorgamer.de/htdocs/shooter/index.php<br>
    /home/www/seniorgamer.de/htdocs/shooter/rss.php<br>
    /home/www/seniorgamer.de/htdocs/shooter/serendipity_admin_image_selector.php<br>
    /home/www/seniorgamer.de/htdocs/shooter/serendipity_admin.php<br>
    /home/www/seniorgamer.de/htdocs/shooter/serendipity_config.inc.php<br>
    /home/www/seniorgamer.de/htdocs/shooter/serendipity.css.php<br>
    /home/www/seniorgamer.de/htdocs/shooter/serendipity_define.js.php<br>
    /home/www/seniorgamer.de/htdocs/shooter/serendipity_editor.js<br>
    /home/www/seniorgamer.de/htdocs/shooter/serendipity_xmlrpc.php<br>
    /home/www/seniorgamer.de/htdocs/shooter/wfwcomment.php<br>
...
<code>/home/www/seniorgamer.de/htdocs/Serendipity/</code> kopiert haben, müssen wir nun
...
<p>Zum einen müssen die drei (leeren) Verzeichnisse <code>upload</code>,
...
<code>/home/www/seniorgamer.de/htdocs/Serendipity/plugins</code> in das Verzeichnis
...
<code>http://blogs.seniorgamer.de/shooter/serendipity_admin.php</code> auf und folgen
...
Datenbank installieren, sollten Sie die <em>Forgeschrittene Installation</em>
...
Sie die Dateien <code>sql/preload.sql</code> mit entsprechenden SQL-Anweisungen füllen.
Wenn Ihr Deployment über die Standardsettings von Serendipity hinaus bestimmte
Plugins vorinstallieren soll, können Sie eine Datei <code>plugins/preload.txt</code>
mit den Namen der Plugin-Klassen (zB. <code>serendipity_event_nl2br</code>) füllen.
