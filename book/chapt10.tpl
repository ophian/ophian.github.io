...
<span class="item-list">
    ...
    <span class="li">(Virtuell legacy) <code class="item sub-file">serendipity_editor.js</code>, (Virtuell) <code class="item sub-file">serendipity_styx.js</code> stellt JavaScript-Funktionen im Backend bereit.</span>
...
<p class="desc">
<code class="item function">serendipity_send()</code>, 
(<code class="item file">include/functions_trackbacks.inc.php</code>)
<span class="desc-info">
    <span class="box">
...
<p class="desc">
<code class="item function">serendipity_calculateAspectSize()</code>,
(<code class="item file">include/functions_images.inc.php</code>)
<span class="desc-info">
    <span class="box">
...
<p>Wenn Sie es vorziehen, und ist im Falle von Styx die einzig praktikable Methode,
können Sie ein <a href="https://github.com/ophian/styx/security/advisories/new" target="_blank">GitHub Styx Security Issue</a> aufmachen,
nicht zu verwechseln mit den normalen issue (Bugfix) trackern, welches Ihre Security Meldung
als Entwurf an den Maintainer sendet, und welche, solange nicht von diesem veröffentlicht,
nur ihm selbst und weiteren bestimmten Mitstreitern zugänglich ist.
Sie sollten uns also Informationen hinterlassen, wie wir Sie eventuell erreichen können,
um Weiteres zu erfahren. Bitte halten Sie die Informationen über das gefundene
<em>“Loch”</em> möglichst genau, damit schnell die Ursache - möglichst anhand eines
allgemeinen Beispieles - gefunden und gefixt werden kann.</p>
...
<p>Andererseits - und das ist die empfohlene Methode - geben Sie dem Deployment einfach
ein leeres und beschreibbares <code>plugins</code> Verzeichnis, analog zu den drei bereits
genannten, damit dort über Spartacus remote installierte Plugin-Programme hinein installiert
werden können. Die Kern Plugins liegen im Kern <code>styx</code> Verzeichnis, während die
"auswärtig" geholten Plugins eines jeden Deployments im eigenen Deployment Ordner liegen.</p>

<p>Ähnliches gilt für das Verzeichnis <code>templates</code>. Dieses müssen Sie auch
entweder symbolisch vom <em>Core</em>-Verzeichnis in das jeweilige <em>Deployment</em>
verknüpfen oder mit Inhalt kopieren. Zu beachten ist die Abwägung zwischen Wartung und
Nutzung. Die Verknüpfung über einen symbolischen Links spart zwar einiges an Redundanz
und Folgearbeiten bei einem Gesamtupgrade, dafür nimmt es den Userblogs aber die
Möglichkeit eines selbsterstellten bzw. veränderten Themes, also ihre Individualisierung.</p>
...
für das <code>docs</code> Verzeichnis, damit Sie im Deployment unter "<em>Wartung</em>" auf das ChangeLog File
von Serendipity Styx zugreifen können.</p>
...
schlüssiges und allgemeines Konzept. Oder es muss klar und eindeutig kommuniziert werden auf ein Deployment
Upgrade durch die einzelnen Blogs zu verzichten. Allerdings kann dies aber durchaus doch geschehen, wenn
